...
void ksiazki::writeToFile()
{
    char ch;
    ofstream f1,f;
    f1.open("zapis_ksiazki.txt", ios::in | ios::app);
...
void ksiazki::readFromFile()
{
    fstream f2;
    string linia;
    int licznik=1;
    f2.open("zapis_ksiazki.txt", ios::out|ios::in|ios::app);
...
void ksiazki::searchOnFile()
{
    ...
    cin>>liczba;
    f3.open("zapis_ksiazki.txt", ios::in | ios::app | ios::out);
...
void ksiazki::deleteFromFile()
{
    ...
    int liczba;
    string linia;
    f4.open("zapis_ksiazki.txt", ios::in|ios::out|ios::app);
...

    {
        ...
        if(usun==true) cout<<"Pomyslnie zwrocono ksiazke!";
        else cout<<"Nie znaleziono ksiazki!";

    f5.close();
    f4.close();
    remove("zapis_ksiazki.txt");
    rename("bufor2.txt", "zapis_ksiazki.txt");
